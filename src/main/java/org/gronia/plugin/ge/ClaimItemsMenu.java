...
public class ClaimItemsMenu extends PageMenu<Gronia> {
    /**
     ...
     */
    public ClaimItemsMenu(Gronia plugin, int pageSize, List<ItemStack> rewards) {
     ...
     */
    private ClaimItemsMenu(Gronia plugin, int pageSize, List<ItemStack> rewards, int rewardStartIndex, int rewardEndIndex) {
        super(plugin.getSubPlugin(GEPlugin.class).getGuiListener(), plugin, new ItemPage(plugin, pageSize, rewards, rewardStartIndex, rewardEndIndex), "Claim your items", null, null);
    ...
    private static class ItemPage extends MenuHolder<Gronia> {
        private final int rewardStartIndex, rewardEndIndex;
        private final List<ItemStack> rewards;
        private ClaimItemsMenu enclosingMenu;

        private ItemPage(Gronia plugin, int pageSize, List<ItemStack> rewards, int rewardStartIndex, int rewardEndIndex) {
